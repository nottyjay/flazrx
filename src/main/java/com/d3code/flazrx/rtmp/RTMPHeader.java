...
public class RTMPHeader {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(RTMPHeader.class);
    ...
    public static final int MAX_ENCODE_SIZE = 18;
    ...
    public RTMPHeader(ByteBuf in, RTMPHeader[] incompletaHeaders){
        ...
        // Remaining Header
        final RTMPHeader prevHeader = incompletaHeaders[channelId];
        switch (headerType) {
            case LARGE:
                time = in.readMedium();
                size = in.readMedium();
